...
public class Main {
	public static void main(String[] args) {
		...
		do {
			...
			System.out.println("Quantas equipes vai ter: OBS Tem que ser um numero par");
	...
	public static Tecnico definirTecnico(String nomeDoTime,Scanner sc) {
		...
		System.out.println("Digite nome do TECNICO do time "+nomeDoTime);
		nome = sc.nextLine();
		...
		for(String chave : campeonatos.keySet()) {	
			...
			for(int key : rodadas.keySet()) {
				...
				for(int numJogo : rodadas.get(key).getJogosDaRodada().keySet()) {
					...
					System.out.println(nomeTimeCasa+" X "+nomeTimeVisitante);
